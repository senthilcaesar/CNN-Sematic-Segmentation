...
from keras.layers import Input,merge, concatenate, Conv2D, MaxPooling2D, Activation, \
                                    UpSampling2D,Dropout,Conv2DTranspose,add,multiply
...
def CompNet(input_shape, learn_rate=1e-3):
    ...
    ''' Encoder 
        Db1 - 04 Conv Layers ( 12, 12, 12, 32 )
        Db2 - 10 COnv Layers ( 12, 12, .., 64 )
        Db3 - 21 Conv Layers ( 12, 12, .., 128 )
        Db4 - 21 Conv Layers ( 12, 12, .., 256 )
        Db5 - 21 Conv Layers ( 12, 12, .., 512 )
    '''
    ...
    merge11 = concatenate(
        [conv3a, conv3b, conv3c, conv3d, conv3e, conv3f, conv3g, conv3h, conv3i, conv3j, conv3k, conv3l])
    ...
    merge12 = concatenate(
        [conv3a, conv3b, conv3c, conv3d, conv3e, conv3f, conv3g, conv3h, conv3i, conv3j, conv3k, conv3l, conv3m])
    ...
    merge14 = concatenate(
        [conv3a, conv3b, conv3c, conv3d, conv3e, conv3f, conv3g, conv3h, conv3i, conv3j, conv3k, conv3l, conv3m, conv3n,
         conv3o])
    ...
    merge18 = concatenate(
        [conv3a, conv3b, conv3c, conv3d, conv3e, conv3f, conv3g, conv3h, conv3i, conv3j, conv3k, conv3l, conv3m, conv3n,
         conv3o, conv3p, conv3q, conv3r, conv3s])
    ...
    merge19 = concatenate(
        [conv3a, conv3b, conv3c, conv3d, conv3e, conv3f, conv3g, conv3h, conv3i, conv3j, conv3k, conv3l, conv3m, conv3n,
         conv3o, conv3p, conv3q, conv3r, conv3s, conv3t])
    ...
    merge11 = concatenate(
        [conv4a, conv4b, conv4c, conv4d, conv4e, conv4f, conv4g, conv4h, conv4i, conv4j, conv4k, conv4l])
    conv4m = Conv2D(12, (kernel_size, kernel_size), activation='relu', padding='same',
                    kernel_regularizer=regularizers.l2(l2_lambda))(merge11)
    conv4m = bn()(conv4m)

    merge12 = concatenate(
        [conv4a, conv4b, conv4c, conv4d, conv4e, conv4f, conv4g, conv4h, conv4i, conv4j, conv4k, conv4l, conv4m])
    ...
    merge14 = concatenate(
        [conv4a, conv4b, conv4c, conv4d, conv4e, conv4f, conv4g, conv4h, conv4i, conv4j, conv4k, conv4l, conv4m, conv4n,
         conv4o])
    ...
    merge18 = concatenate(
        [conv4a, conv4b, conv4c, conv4d, conv4e, conv4f, conv4g, conv4h, conv4i, conv4j, conv4k, conv4l, conv4m, conv4n,
         conv4o, conv4p, conv4q, conv4r, conv4s])
    ...
    merge19 = concatenate(
        [conv4a, conv4b, conv4c, conv4d, conv4e, conv4f, conv4g, conv4h, conv4i, conv4j, conv4k, conv4l, conv4m, conv4n,
         conv4o, conv4p, conv4q, conv4r, conv4s, conv4t])
    ...
    merge12 = concatenate(
        [conv5a, conv5b, conv5c, conv5d, conv5e, conv5f, conv5g, conv5h, conv5i, conv5j, conv5k, conv5l, conv5m])
    ...
    merge14 = concatenate(
        [conv5a, conv5b, conv5c, conv5d, conv5e, conv5f, conv5g, conv5h, conv5i, conv5j, conv5k, conv5l, conv5m, conv5n,
         conv5o])
    ...
    merge18 = concatenate(
        [conv5a, conv5b, conv5c, conv5d, conv5e, conv5f, conv5g, conv5h, conv5i, conv5j, conv5k, conv5l, conv5m, conv5n,
         conv5o, conv5p, conv5q, conv5r, conv5s])
    ...
    merge19 = concatenate(
        [conv5a, conv5b, conv5c, conv5d, conv5e, conv5f, conv5g, conv5h, conv5i, conv5j, conv5k, conv5l, conv5m, conv5n,
         conv5o, conv5p, conv5q, conv5r, conv5s, conv5t])
    ...
    ''' Decoder Segmentation Branch, Learn Brain region 
        Db6 - 21 Conv Layers ( 12, 12, 12, 256 )
        Db7 - 21 COnv Layers ( 12, 12, .., 128 )
        Db8 - 10 Conv Layers ( 12, 12, .., 64 )
        Db9 - 04 Conv Layers ( 12, 12, .., 32 )
    '''
    ...
    merge11 = concatenate(
        [up6, conv6a, conv6b, conv6c, conv6d, conv6e, conv6f, conv6g, conv6h, conv6i, conv6j, conv6k, conv6l])
    conv6m = Conv2D(12, (kernel_size, kernel_size), activation='relu', padding='same',
                    kernel_regularizer=regularizers.l2(l2_lambda))(merge11)
    conv6m = bn()(conv6m)

    merge12 = concatenate(
        [up6, conv6a, conv6b, conv6c, conv6d, conv6e, conv6f, conv6g, conv6h, conv6i, conv6j, conv6k, conv6l, conv6m])
    ...
    merge17 = concatenate(
        [up6, conv6a, conv6b, conv6c, conv6d, conv6e, conv6f, conv6g, conv6h, conv6i, conv6j, conv6k, conv6l, conv6m,
         conv6n, conv6o, conv6p, conv6q, conv6r])
    ...
    merge18 = concatenate(
        [up6, conv6a, conv6b, conv6c, conv6d, conv6e, conv6f, conv6g, conv6h, conv6i, conv6j, conv6k, conv6l, conv6m,
         conv6n, conv6o, conv6p, conv6q, conv6r, conv6s])
    ...
    merge19 = concatenate(
        [up6, conv6a, conv6b, conv6c, conv6d, conv6e, conv6f, conv6g, conv6h, conv6i, conv6j, conv6k, conv6l, conv6m,
         conv6n, conv6o, conv6p, conv6q, conv6r, conv6s, conv6t])
    ...
    merge11 = concatenate(
        [up7, conv7a, conv7b, conv7c, conv7d, conv7e, conv7f, conv7g, conv7h, conv7i, conv7j, conv7k, conv7l])
    conv7m = Conv2D(12, (kernel_size, kernel_size), activation='relu', padding='same',
                    kernel_regularizer=regularizers.l2(l2_lambda))(merge11)
    conv7m = bn()(conv7m)

    merge12 = concatenate(
        [up7, conv7a, conv7b, conv7c, conv7d, conv7e, conv7f, conv7g, conv7h, conv7i, conv7j, conv7k, conv7l, conv7m])
    ...
    merge17 = concatenate(
        [up7, conv7a, conv7b, conv7c, conv7d, conv7e, conv7f, conv7g, conv7h, conv7i, conv7j, conv7k, conv7l, conv7m,
         conv7n, conv7o, conv7p, conv7q, conv7r])
    ...
    merge18 = concatenate(
        [up7, conv7a, conv7b, conv7c, conv7d, conv7e, conv7f, conv7g, conv7h, conv7i, conv7j, conv7k, conv7l, conv7m,
         conv7n, conv7o, conv7p, conv7q, conv7r, conv7s])
    ...
    merge19 = concatenate(
        [up7, conv7a, conv7b, conv7c, conv7d, conv7e, conv7f, conv7g, conv7h, conv7i, conv7j, conv7k, conv7l, conv7m,
         conv7n, conv7o, conv7p, conv7q, conv7r, conv7s, conv7t])
    ...
    ''' Decoder Complementary Branch, Learn Non-Brain region 
        Db10 - 21 Conv Layers ( 12, 12, 12, 256 )
        Db11 - 21 COnv Layers ( 12, 12, .., 128 )
        Db12 - 10 Conv Layers ( 12, 12, .., 64 )
        Db13 - 04 Conv Layers ( 12, 12, .., 32 )
    '''
    xup6 = concatenate([Conv2DTranspose(24, (2, 2), strides=(2, 2), padding='same')(conv5u), conv4u], name='xup6',
                       axis=3)
    ...
    merge9 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j])
    ...
    merge10 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k])
    ...
    merge14 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k,
         xconv6l, xconv6m, xconv6n, xconv6o])
    ...
    merge15 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k,
         xconv6l, xconv6m, xconv6n, xconv6o, xconv6p])
    ...
    merge16 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k,
         xconv6l, xconv6m, xconv6n, xconv6o, xconv6p, xconv6q])
    ...
    merge17 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k,
         xconv6l, xconv6m, xconv6n, xconv6o, xconv6p, xconv6q, xconv6r])
    ...
    merge18 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k,
         xconv6l, xconv6m, xconv6n, xconv6o, xconv6p, xconv6q, xconv6r, xconv6s])
    ...
    merge19 = concatenate(
        [xup6, xconv6a, xconv6b, xconv6c, xconv6d, xconv6e, xconv6f, xconv6g, xconv6h, xconv6i, xconv6j, xconv6k,
         xconv6l, xconv6m, xconv6n, xconv6o, xconv6p, xconv6q, xconv6r, xconv6s, xconv6t])
    xconv6u = Conv2D(256, (kernel_size, kernel_size), activation='relu', padding='same',
                     kernel_regularizer=regularizers.l2(l2_lambda))(merge19)
    xconv6u = bn()(xconv6u)

    xup7 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xconv6u), conv3u], name='xup7',
                       axis=3)
    ...
    merge9 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j])
    ...
    merge10 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k])
    ...
    merge14 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k,
         xconv7l, xconv7m, xconv7n, xconv7o])
    ...
    merge15 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k,
         xconv7l, xconv7m, xconv7n, xconv7o, xconv7p])
    ...
    merge16 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k,
         xconv7l, xconv7m, xconv7n, xconv7o, xconv7p, xconv7q])
    ...
    merge17 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k,
         xconv7l, xconv7m, xconv7n, xconv7o, xconv7p, xconv7q, xconv7r])
    ...
    merge18 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k,
         xconv7l, xconv7m, xconv7n, xconv7o, xconv7p, xconv7q, xconv7r, xconv7s])
    ...
    merge19 = concatenate(
        [xup7, xconv7a, xconv7b, xconv7c, xconv7d, xconv7e, xconv7f, xconv7g, xconv7h, xconv7i, xconv7j, xconv7k,
         xconv7l, xconv7m, xconv7n, xconv7o, xconv7p, xconv7q, xconv7r, xconv7s, xconv7t])
    xconv7u = Conv2D(128, (kernel_size, kernel_size), activation='relu', padding='same',
                     kernel_regularizer=regularizers.l2(l2_lambda))(merge19)
    xconv7u = bn()(xconv7u)

    xup8 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xconv7u), conv2j], name='xup8',
                       axis=3)
    ...
    xup9 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xconv8j), conv1d], name='xup9',
                       axis=3)
    ...
    u_net_op0 = concatenate([final_op, xfinal_op])
    u_net_op1 = concatenate([conv10, xconv10])
    u_net_op2 = concatenate([output4, xoutput4])
    u_net_op3 = concatenate([output3, xoutput3])
    u_net_op4 = concatenate([output2, xoutput2])
    u_net_op5 = concatenate([output1, xoutput1])

    # Concatenation fed to the reconstruction subnetwork layer
    ''' Encoder 
        Db1 - 04 Conv Layers ( 12, 12, 12, 32 )
        Db2 - 10 COnv Layers ( 12, 12, .., 64 )
        Db3 - 21 Conv Layers ( 12, 12, .., 128 )
    ...
    merge9 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j])
    ...
    merge10 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k])
    ...
    merge14 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k,
         xxconv3l, xxconv3m, xxconv3n, xxconv3o])
    ...
    merge15 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k,
         xxconv3l, xxconv3m, xxconv3n, xxconv3o, xxconv3p])
    ...
    merge16 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k,
         xxconv3l, xxconv3m, xxconv3n, xxconv3o, xxconv3p, xxconv3q])
    ...
    merge17 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k,
         xxconv3l, xxconv3m, xxconv3n, xxconv3o, xxconv3p, xxconv3q, xxconv3r])
    ...
    merge18 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k,
         xxconv3l, xxconv3m, xxconv3n, xxconv3o, xxconv3p, xxconv3q, xxconv3r, xxconv3s])
    ...
    merge19 = concatenate(
        [xxconv3a, xxconv3b, xxconv3c, xxconv3d, xxconv3e, xxconv3f, xxconv3g, xxconv3h, xxconv3i, xxconv3j, xxconv3k,
         xxconv3l, xxconv3m, xxconv3n, xxconv3o, xxconv3p, xxconv3q, xxconv3r, xxconv3s, xxconv3t])
    ...
    merge9 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j])
    ...
    merge14 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j, xxconv4k,
         xxconv4l, xxconv4m, xxconv4n, xxconv4o])
    ...
    merge15 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j, xxconv4k,
         xxconv4l, xxconv4m, xxconv4n, xxconv4o, xxconv4p])
    ...
    merge16 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j, xxconv4k,
         xxconv4l, xxconv4m, xxconv4n, xxconv4o, xxconv4p, xxconv4q])
    ...
    merge17 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j, xxconv4k,
         xxconv4l, xxconv4m, xxconv4n, xxconv4o, xxconv4p, xxconv4q, xxconv4r])
    ...
    merge18 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j, xxconv4k,
         xxconv4l, xxconv4m, xxconv4n, xxconv4o, xxconv4p, xxconv4q, xxconv4r, xxconv4s])
    ...
    merge19 = concatenate(
        [xxconv4a, xxconv4b, xxconv4c, xxconv4d, xxconv4e, xxconv4f, xxconv4g, xxconv4h, xxconv4i, xxconv4j, xxconv4k,
         xxconv4l, xxconv4m, xxconv4n, xxconv4o, xxconv4p, xxconv4q, xxconv4r, xxconv4s, xxconv4t])
    ...
    merge9 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j])
    ...
    merge10 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k])
    ...
    merge14 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k,
         xxconv5l, xxconv5m, xxconv5n, xxconv5o])
    ...
    merge15 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k,
         xxconv5l, xxconv5m, xxconv5n, xxconv5o, xxconv5p])
    ...
    merge16 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k,
         xxconv5l, xxconv5m, xxconv5n, xxconv5o, xxconv5p, xxconv5q])
    ...
    merge17 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k,
         xxconv5l, xxconv5m, xxconv5n, xxconv5o, xxconv5p, xxconv5q, xxconv5r])
    ...
    merge18 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k,
         xxconv5l, xxconv5m, xxconv5n, xxconv5o, xxconv5p, xxconv5q, xxconv5r, xxconv5s])
    ...
    merge19 = concatenate(
        [xxconv5a, xxconv5b, xxconv5c, xxconv5d, xxconv5e, xxconv5f, xxconv5g, xxconv5h, xxconv5i, xxconv5j, xxconv5k,
         xxconv5l, xxconv5m, xxconv5n, xxconv5o, xxconv5p, xxconv5q, xxconv5r, xxconv5s, xxconv5t])
    xxconv5u = Conv2D(512, (kernel_size, kernel_size), activation='relu', padding='same',
                      kernel_regularizer=regularizers.l2(l2_lambda))(merge19)
    xxconv5u = bn()(xxconv5u)

    xxup6 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xxconv5u), xxconv4u], name='xxup6',
                        axis=3)
    ...
    ''' Decoder
        Db1 - 21 Conv Layers ( 12, 12, 12, 256 )
        Db2 - 21 COnv Layers ( 12, 12, .., 128 )
        Db3 - 10 Conv Layers ( 12, 12, .., 64 )
        Db4 - 04 Conv Layers ( 12, 12, .., 32 )
    '''
    ...
    merge8 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i])
    ...
    merge9 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j])
    ...
    merge13 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j,
         xxconv6k, xxconv6l, xxconv6m, xxconv6n])
    ...
    merge14 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j,
         xxconv6k, xxconv6l, xxconv6m, xxconv6n, xxconv6o])
    ...
    merge16 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j,
         xxconv6k, xxconv6l, xxconv6m, xxconv6n, xxconv6o, xxconv6p, xxconv6q])
    ...
    merge17 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j,
         xxconv6k, xxconv6l, xxconv6m, xxconv6n, xxconv6o, xxconv6p, xxconv6q, xxconv6r])
    ...
    merge18 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j,
         xxconv6k, xxconv6l, xxconv6m, xxconv6n, xxconv6o, xxconv6p, xxconv6q, xxconv6r, xxconv6s])
    ...
    merge19 = concatenate(
        [xxup6, xxconv6a, xxconv6b, xxconv6c, xxconv6d, xxconv6e, xxconv6f, xxconv6g, xxconv6h, xxconv6i, xxconv6j,
         xxconv6k, xxconv6l, xxconv6m, xxconv6n, xxconv6o, xxconv6p, xxconv6q, xxconv6r, xxconv6s, xxconv6t])
    xxconv6u = Conv2D(256, (kernel_size, kernel_size), activation='relu', padding='same',
                      kernel_regularizer=regularizers.l2(l2_lambda))(merge19)
    xxconv6u = bn()(xxconv6u)

    xxup7 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xxconv6u), xxconv3u], name='xxup7',
                        axis=3)
    ...
    merge8 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i])
    ...
    merge9 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j])
    ...
    merge13 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n])
    ...
    merge14 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n, xxconv7o])
    ...
    merge15 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n, xxconv7o, xxconv7p])
    ...
    merge16 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n, xxconv7o, xxconv7p, xxconv7q])
    ...
    merge17 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n, xxconv7o, xxconv7p, xxconv7q, xxconv7r])
    ...
    merge18 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n, xxconv7o, xxconv7p, xxconv7q, xxconv7r, xxconv7s])
    ...
    merge19 = concatenate(
        [xxup7, xxconv7a, xxconv7b, xxconv7c, xxconv7d, xxconv7e, xxconv7f, xxconv7g, xxconv7h, xxconv7i, xxconv7j,
         xxconv7k, xxconv7l, xxconv7m, xxconv7n, xxconv7o, xxconv7p, xxconv7q, xxconv7r, xxconv7s, xxconv7t])
    xxconv7u = Conv2D(128, (kernel_size, kernel_size), activation='relu', padding='same',
                      kernel_regularizer=regularizers.l2(l2_lambda))(merge19)
    xxconv7u = bn()(xxconv7u)

    xxup8 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xxconv7u), xxconv2j], name='xxup8',
                        axis=3)
    ...
    merge8 = concatenate(
        [xxup8, xxconv8a, xxconv8b, xxconv8c, xxconv8d, xxconv8e, xxconv8f, xxconv8g, xxconv8h, xxconv8i])
    ...
    xxup9 = concatenate([Conv2DTranspose(12, (2, 2), strides=(2, 2), padding='same')(xxconv8j), xxconv1d], name='xxup9',
                        axis=3)
    ...
    model = Model(inputs=inputs,
                  outputs=[output1, output2, output3, output4, conv10, final_op, xoutput1, xoutput2, xoutput3, xoutput4,
                           xconv10, xfinal_op, xxoutput1, xxoutput2, xxoutput3, xxoutput4, xxconv10, xxfinal_op])
